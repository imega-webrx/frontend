...
const Ready = () => (
    <Container>
        <Section>
            <Title>
                <Question>
                    Нужна бесплатная консультация провизора или ветеринарного
                    врача?
                </Question>
                <Todo>Напиши в чат.</Todo>
            </Title>
            <ButtonArea>
                <GetStartedBlock>
                ...
                <LearnMoreBlock>
                    <LearnMoreLink href="#">Узнать больше</LearnMoreLink>
                </LearnMoreBlock>
            </ButtonArea>
        </Section>
    </Container>
...
const Section = tw(
    "div"
)`max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between`;
const Title = tw(
    "h2"
...
const LearnMoreLink = tw(
    "a"
)`inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50`;
